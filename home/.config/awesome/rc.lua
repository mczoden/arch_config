...
local LAYOUT_FLOATING = 1
local LAYOUT_TILE = 2
local LAYOUT_TILE_LEFT = 3
local LAYOUT_TILE_BOTTOM = 4
local LAYOUT_TILE_TOP = 5
local LAYOUT_MAX = 10
local LAYOUT_MAX_FULLSCREEN = 11
...
-- Launcher: same as "Start" in Windows
